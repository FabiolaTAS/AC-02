...
class PerfilAdapter(
    ...
    val onClick: (Perfil) -> Unit
) : RecyclerView.Adapter<PerfilAdapter.PefilViewHoder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PefilViewHoder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.adapter_perfil, parent, false)
